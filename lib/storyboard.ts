...
function tamilPromoNarration(index: number, total: number, productName: string) {
  const lines = [
    'நண்பர்களோடு செலவு பகிர்ந்ததும், கணக்கு மட்டும் குழப்பமாகிப் போகுதா?',
    'யார் எவ்வளவு கொடுத்தாங்க, யாருக்கு எவ்வளவு பாக்கி — இதை தனியா நினைச்சுக்கிட்டு இருக்க வேண்டிய அவசியமே இல்லை.',
    `${productName}. பகிர்ந்த செலவுகளை சுலபமாக பதிவு செய்து, எல்லாருடைய கணக்கையும் ஒரே இடத்தில் தெளிவாக பார்க்கலாம்.`,
    'ஒரு செலவை சேர்த்த உடனே, யார் கொடுத்தது, யாருக்கு பகிரணும், எவ்வளவு பாக்கி — கணக்கு தானாக அப்டேட் ஆகும்.',
    'Balance, settlement, history — எல்லாமே தெளிவா. குழப்பம் குறையும்; நேரமும் சேமிக்கும்.',
    'Roommates, நண்பர்கள், family, trip — எங்க பகிர்ந்த செலவு இருக்குதோ, அங்க இந்த ஆப் பயனாக இருக்கும்.',
    'செலவு பதிவு பண்ணுங்க. Balance பாருங்க. Settlement முடிச்சிடுங்க. அவ்வளவுதான்.',
    `${productName}. பகிர்ந்த செலவுக்கு ஒரு சுலபமான கணக்கு. இன்றே பயன்படுத்திப் பாருங்கள்.`,
  ];
  if (total <= 5) {
